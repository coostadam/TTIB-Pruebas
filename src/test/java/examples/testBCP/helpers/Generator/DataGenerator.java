...
public class DataGenerator {
    ...
    public static void generateAV2(Map<String, Object> av2Map) {
        AV2Message av2 = AV2Message.fromMap(av2Map);

        lastAV2 = av2;

        saveCSV("src/test/java/examples/testBCP/data/csv/dataAV2.csv", AV2Message.returnCSVHeaders(), List.of(av2));
    }

    public static void loadAV3(Map<String, Object> av3Map) {
        AV3Message av3 = AV3Message.fromMap(av3Map);

        lastAV3 = av3;

        saveCSV("src/test/java/examples/testBCP/data/csv/dataAV3.csv", AV3Message.returnCSVHeaders(), List.of(av3));
    }

    public static void generateCT2() {
        ...
        saveCSV("src/test/java/examples/testBCP/data/csv/dataCT2.csv", CT2Message.returnCSVHeaders(), List.of(ct2));
    }

    public static void loadCT3(Map<String, Object> ct3Map) {
        CT3Message ct3 = CT3Message.fromMap(ct3Map);

        lastCT3 = ct3;

        saveCSV("src/test/java/examples/testBCP/data/csv/dataCT3.csv", CT3Message.returnCSVHeaders(), List.of(ct3));
    }
    ...
    public static void generateCT5() {
        ...
        saveCSV("src/test/java/examples/testBCP/data/csv/dataCT5.csv", CT5Message.returnCSVHeaders(), List.of(ct5));
    }

    private static void saveCSV(String filename, String header, List<?> messages) {
