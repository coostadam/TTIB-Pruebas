...
Feature: Validar el bloqueo de entidad receptora
  ...
  Background:
    * url apiUrl
    * def jsonErrorAECWeb = read('examples/testBCP/features/SmokeTest/jsonData/invalidData/cuenta_cerrada.json')
    * def jsonErrorPCTWeb = read('examples/testBCP/features/SmokeTest/jsonData/invalidData/monto_cero.json')
